...
function App() {
  ...
  const steps =[
    {
      id:'Greet',
      message:'Hello, Welcome to our New Ed-Tech website',
      trigger:'Ask Name',
    },
    {
      id:'Ask Name',
    ...
    },
    {
      ...
      options: [
        ...
        { value:"App Development", label:"App Development",trigger:"App Development"},
        { value:"Other Issues", label:"Other Issues",trigger:"Other Issues"},
      ],
    },  
    {
      id: "Web Development",
      message: "go to Category => select Web Development courses and get ready to make new websites",
      end: true,
    },
    {
      id: "App Development",
      message: "go to Category => select Web Development courses and get ready to make new apps",
      end: true,
    },
    {
      id: "Other Issues",
